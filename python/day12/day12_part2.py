...
start_options = [Cell(location=(i, 0), height=1, g=0, f=0) for i in range(grid_height)]

shortest = math.inf
for count, start_node in enumerate(start_options):
    print(f"Process {count} of {len(start_options)}")
